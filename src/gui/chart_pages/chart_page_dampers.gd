...
var speed_rl: Array[float] = []
var speed_rr: Array[float] = []
var speed_fl: Array[float] = []
var speed_fr: Array[float] = []
var bin_width := 10.0
var max_speed := 200.0
var slow_speed := 25.0
var histogram_rl: DamperHistogram = null
var histogram_rr: DamperHistogram = null
var histogram_fl: DamperHistogram = null
var histogram_fr: DamperHistogram = null
...
func recompute_data() -> void:
	if main_lap:
		speed_rl = chart_creator.get_data(main_lap, "suspension_speed_rl")
		speed_rr = chart_creator.get_data(main_lap, "suspension_speed_rr")
		speed_fl = chart_creator.get_data(main_lap, "suspension_speed_fl")
		speed_fr = chart_creator.get_data(main_lap, "suspension_speed_fr")
		histogram_rl = DamperHistogram.new(speed_rl, bin_width, max_speed, slow_speed)
		histogram_rr = DamperHistogram.new(speed_rr, bin_width, max_speed, slow_speed)
		histogram_fl = DamperHistogram.new(speed_fl, bin_width, max_speed, slow_speed)
		histogram_fr = DamperHistogram.new(speed_fr, bin_width, max_speed, slow_speed)
	stale = false
